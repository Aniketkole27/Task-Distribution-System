        ...
        <div className='p-4 mx-4  border border-stone-300 rounded h-fit'>
            <div className='flex items-center justify-between mb-8'>
                ...
                <button
                    ...
                    className='text-xs bg-stone-200 rounded px-2 py-1 cursor-pointer hover:bg-stone-300 active:bg-stone-400'>
                    view all
                </button>
            </div>
...
const ProjectCardSkeleton = () => {
    ...
    return (
        <div className='p-4 border-2 border-stone-300 rounded flex items-center justify-between my-3 animate-pulse'>

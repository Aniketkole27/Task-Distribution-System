...
const Header = () => {
    ...
    return (
        <>
            <div
                className="flex  flex-col lg:flex-row items-center justify-between gap-4 w-full bg-white/50 dark:bg-[#0f172a]/50 backdrop-blur-xl p-4 rounded-2xl border border-slate-200/50 dark:border-slate-800/50 shadow-sm transition-all duration-300 hover:shadow-md">
            ...
            <div>
                <p
                    ...
                    className="text-sm inline hover:text-[#90b8f0] cursor-pointer text-slate-600 dark:text-slate-300 mt-2"
                >

                    Total project your are working on: <span className=" inline font-bold">3</span>
                </p>
            </div>
            ...
            {/* <ShowProjectSidebar setShowProjectSidebar={setShowProjectSidebar} /> */}
        </>
    )
}
